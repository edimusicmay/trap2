...
canvas.addEventListener('touchstart', (e) => {
  ...
  for (let touch of e.touches) {
    ...
    if (touchedSpaceship) continue; // Skip note interaction

    // Otherwise, simulate lane key press
